...
The matrix $A$ is generated by using the MATLAB package [AIR Tools II](https://github.com/jakobsj/AIRToolsII), described in the [publication](https://doi.org/10.1007/s11075-017-0430-x). Specifically, the following code was used to generate the forward model matrix:
```matlab
