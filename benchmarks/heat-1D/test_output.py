...
assert np.allclose(output_kl_expansion_function2coefficient, domain_geometry_large_noise.fun2par(np.array(output_kl_expansion_coefficient2function)))
...
assert np.linalg.norm(output_kl_expansion_function2coefficient) == pytest.approx(2.878663657007402)
